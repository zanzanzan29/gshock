...
public class AdminIndexDeliverysController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private TordersDAO tordersDAO;   
    private Torder_detailDAO torder_detailDAO;
    
    public AdminIndexDeliverysController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/admin/deliverys/index.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		tordersDAO.editRS(id);
		response.getWriter().print("Đã Giao Hàng");
	}
