						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<%
										Categories itemCat = (Categories) request.getAttribute("itemCat");
									...
									<form action="" method="post">
										<div class="card-body">
											<div class="form-group">
												...
												<input name="name" type="text" class="form-control" id="text" placeholder="Nhập Tên Cửa Hàng" value="<%if(name != null){out.print(name);}else{out.print(itemCat.getName());}%>">
											</div>
